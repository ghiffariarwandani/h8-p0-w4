function countProfit(shoppers) {
  ...
  for(var i=0;i<shoppers.length;i++){
    ...
    if(shoppers[i].product === "Baju Zoro" && result[1].leftOver >= shoppers[i].amount ){
    ...
    if(shoppers[i].product === "Sweater Uniklooh" && result[2].leftOver >= shoppers[i].amount ){
